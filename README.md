...
* [Skolengo](#Skolengo)
    ...
    * _instance_
        ...
        * [.getAbsenceFiles(studentId, limit, offset, params, includes, filterAbsenceType)](#Skolengo+getAbsenceFiles)
...
### skolengo.getAbsenceFiles(studentId, limit, offset, params, includes, filterAbsenceType)
...
| params | <code>object</code> |  | Modifier les paramètres de la requête |
| includes | <code>Array.&lt;string&gt;</code> |  | Ressources JSON:API à inclure |
| filterAbsenceType | <code>Array.&lt;SupportedAbsenceType&gt;</code> |  | Filtrer les types d'absence |
